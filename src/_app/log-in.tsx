      ...
      <div className="mx-auto flex max-w-96 flex-col gap-y-8 px-4 md:px-0">
        <header className="text-center">
          <div className="relative mt-8">
            <h1 className="text-display-xs lg:text-display-sm font-semibold lg:mt-16">
        ...
        {formState.message.length > 0 && (
          <div className="shadow-xs relative rounded-xl border border-gray-300 bg-white p-4">
            <div className="relative inline-block">
              <div className="border-error-600/30 absolute left-1/2 top-1/2 size-[calc(100%+6px)] -translate-x-1/2 -translate-y-1/2 rounded-full border-2" />
              <div className="border-error-600/10 absolute left-1/2 top-1/2 size-[calc(100%+12px)] -translate-x-1/2 -translate-y-1/2 rounded-full border-2" />
              <CircleAlert className="stroke-error-600 size-5" size={20} />
            </div>
