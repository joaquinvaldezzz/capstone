    ...
    <Fragment>
      <div className="print:hidden">
        <div className="mb-6 flex flex-wrap items-center justify-between gap-4">
          <div>
            <h2 className="text-2xl font-semibold">Your ultrasound result is here!</h2>
        ...
        <div className="max-w-(--breakpoint-md)">
          ...
          <p className="mt-4">
            {result?.diagnosis === "Infected" ? (
              <Fragment>
                ...
                ovaries typically show multiple small follicles arranged peripherally. Please
                discuss these findings with Dr. {result.doctor_first_name} {result.doctor_last_name}{" "}
                to review comprehensive symptoms, hormonal evaluations, and personalized management
                plans.
              </Fragment>
            ) : (
              <Fragment>
                Your ultrasound scan indicates normal ovarian morphology, with an AI confidence
                score of <span className="font-semibold text-gray-900">{result.percentage}</span>.
                No significant polycystic features were identified. Continue following your routine
          ...
          <Alert className="mt-6">
            ...
            <AlertDescription className="text-xs text-muted-foreground">
              Note: This ultrasound analysis is generated with algorithmic assistance. Formal
              medical diagnosis requires correlation with clinical symptoms and laboratory tests by
